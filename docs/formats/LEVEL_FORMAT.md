...
rest (see [subsystems/SECTOR.md](../subsystems/SECTOR.md) once Phase D lands).
...
A compiled level is an archive `LEVELS/<NAME>.PS2R` (see [ARCHIVE_FORMAT.md](ARCHIVE_FORMAT.md))
containing:
...
and staged into the distribution under `LEVELS/` by the packaging stage. See [PIPELINE.md](../PIPELINE.md).
