...
inline Color3 MakeColor(int r, int g, int b)
{
    return Color3{static_cast<float>(r) / 255.0f,
...
{
    if (strcmp(btn, "x") == 0)          return GamePadButton::Cross;
    if (strcmp(btn, "cir") == 0)        return GamePadButton::Circle;
    if (strcmp(btn, "squ") == 0)        return GamePadButton::Square;
    if (strcmp(btn, "tri") == 0)        return GamePadButton::Triangle;
    if (strcmp(btn, "dpad_up") == 0)    return GamePadButton::DPadUp;
    if (strcmp(btn, "dpad_down") == 0)  return GamePadButton::DPadDown;
    if (strcmp(btn, "dpad_left") == 0)  return GamePadButton::DPadLeft;
    if (strcmp(btn, "dpad_right") == 0) return GamePadButton::DPadRight;
    if (strcmp(btn, "l1") == 0)         return GamePadButton::L1;
    if (strcmp(btn, "l2") == 0)         return GamePadButton::L2;
    if (strcmp(btn, "r1") == 0)         return GamePadButton::R1;
    if (strcmp(btn, "r2") == 0)         return GamePadButton::R2;
    if (strcmp(btn, "l3") == 0)         return GamePadButton::L3;
    if (strcmp(btn, "r3") == 0)         return GamePadButton::R3;
    if (strcmp(btn, "start") == 0)      return GamePadButton::Start;
    if (strcmp(btn, "select") == 0)     return GamePadButton::Select;
...
void DrawCube(float x, float y, float z, float size, int r, int g, int b)
{
    Renderer* renderer = Engine_GetRenderer();
    if (renderer)
        renderer->AddPrimitiveToDrawList(Primitive3D::Cube,
                                         Vector3{x, y, z}, Vector3{0.f, 0.f, 0.f},
                                         Vector3{size, size, size}, MakeColor(r, g, b));
}
...
void DrawSphere(float x, float y, float z, float size, int r, int g, int b)
{
    Renderer* renderer = Engine_GetRenderer();
    if (renderer)
        renderer->AddPrimitiveToDrawList(Primitive3D::Sphere,
                                         Vector3{x, y, z}, Vector3{0.f, 0.f, 0.f},
                                         Vector3{size, size, size}, MakeColor(r, g, b));
}
...
void DrawCylinder(float x, float y, float z, float size, int r, int g, int b)
{
    Renderer* renderer = Engine_GetRenderer();
    if (renderer)
        renderer->AddPrimitiveToDrawList(Primitive3D::Cylinder,
                                         Vector3{x, y, z}, Vector3{0.f, 0.f, 0.f},
                                         Vector3{size, size, size}, MakeColor(r, g, b));
}
...
void DrawCubeTextured(float x, float y, float z, float size, int textureId)
{
    ...
    if (renderer)
        renderer->AddPrimitiveToDrawList(Primitive3D::Cube,
                                         ...
                                         Color3{1.0f, 1.0f, 1.0f}, static_cast<int32_t>(textureId));
}
...
int LoadResource(const char* type, const char* path)
{
    ...
    if (strcmp(type, "TEXTURE") == 0)      t = RES_TEXTURE;
    else if (strcmp(type, "MODEL") == 0)   t = RES_MODEL;
    else if (strcmp(type, "SOUND") == 0)   t = RES_SOUND;
    else if (strcmp(type, "FONT") == 0)    t = RES_FONT;
    else
