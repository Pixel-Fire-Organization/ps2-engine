...
#define MEM_BLOCK_SCRIPT_SIZE (4 * 1024 * 1024) // 4 MB
#define MEM_BLOCK_SCRIPT_SLOTS 8 // 512 KB per slot (4 units * 2 slots each)

#define MEM_BLOCK_CONFIG_SIZE (256 * 1024) // 256 KB
#define MEM_BLOCK_CONFIG_SLOTS 4

#define MEM_BLOCK_LEVEL_DATA_SIZE (2 * 1024 * 1024) // 2 MB
